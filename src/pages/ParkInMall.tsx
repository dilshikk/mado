...
const PDF_URL = "https://mado.uz/uploads/parkmenu.pdf?v=2";
...
export default function ParkInMall() {
  ...
  if (error) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center gap-4 bg-white p-6 text-center">
        <PageMeta slug="parkinmall" lang={lang} />
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      {/* Reads meta_title / meta_description from the "parkinmall" page in admin */}
      <PageMeta slug="parkinmall" lang={lang} />
